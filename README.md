...
| パス | 内容 |
| --- | --- |
| `/` | 店名・パートナー区分・大事にしていること・始めたきっかけ・事業内容・担当エリア・施工事例・店舗情報 |
| `/works` | 静岡EASTの施工事例の一覧 |
| `/works/[slug]` | 施工事例の詳細（施工前後の写真・ご要望・工夫したこと） |
| `/about` | 代表挨拶・会社概要（本部との関係） |
| `/area` | 担当エリア（静岡県東部・伊豆・静岡市） |
