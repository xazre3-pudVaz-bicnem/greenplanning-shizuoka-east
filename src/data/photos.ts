...
export const photos = {
  ...
  productAmazingTurfLite: {
    ...
    width: 500,
    height: 280,
    alt: 'アメイジングターフ Lite の断面。黄緑の芝葉と、その根元の黄色い下葉',
    source: 'provided',
    credit: PROVIDED_PRODUCT,
  },
  productIslandGrassR: {
  ...
  productIslandGrassC: {
    ...
    width: 500,
    height: 280,
    alt: 'アイランドグラス タイプＣの断面。細い緑の芝葉と黄色い下葉',
    source: 'provided',
    credit: PROVIDED_PRODUCT,
  },
  productIslandGrassG: {
    ...
    width: 500,
    height: 280,
    alt: 'アイランドグラス タイプＧの断面。明るい緑と黄緑の2色の芝葉',
    source: 'provided',
    credit: PROVIDED_PRODUCT,
  },
  productGolfGreen: {
    ...
    width: 500,
    height: 280,
    alt: 'ゴルフグリーン用ターフの表面。短く密に詰まった緑の芝葉',
    source: 'provided',
    credit: PROVIDED_PRODUCT,
  },
  productGeofill: {
    ...
    width: 500,
    height: 280,
    alt: '人工芝充填材ジオフィルを使った断面の図。人工芝の下に茶色と砂色の層',
    source: 'provided',
    credit: PROVIDED_PRODUCT,
  },
  representative: {
